...
public class ApplyInvisibility extends CEScheduledCommand {
	...
	public String toScheduledCommandWithComment() {
		...
		String command = "execute as @e[tag=CE_invisible] run data merge entity @s {NoGravity:0b,Silent:1b,active_effects:[{id:\"minecraft:invisibility\",amplifier:0b,duration:401,show_particles:0b}]}";
