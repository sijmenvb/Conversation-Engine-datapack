...
execute if score bool CE_suc2 matches 0 if entity @a[scores={lab_ape=1}] run scoreboard players set bool CE_suc2 2 
...
# else:
    ...
    execute if score bool CE_suc2 matches 0 run scoreboard players set @p[scores={lab_ape=1}] CE_current_node 0

    # give the choises using the trigger command.
    execute if score bool CE_suc2 matches 0 run scoreboard players set @p[scores={lab_ape=1}] CE_trigger 3 
