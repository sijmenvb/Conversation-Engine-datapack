...
execute if score @s CE_current_node matches 1 run scoreboard players set bool CE_suc 1
...
execute store success score bool CE_resend if score @s CE_current_node matches 2 run scoreboard players set bool CE_suc 1
